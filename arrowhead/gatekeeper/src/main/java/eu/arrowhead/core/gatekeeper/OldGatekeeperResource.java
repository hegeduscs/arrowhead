...
public class OldGatekeeperResource {
	
	private static Logger log = Logger.getLogger(OldGatekeeperResource.class.getName());
    ...
    @PUT
    @Path("/init_icn/")
    public ICNResult sendProposal(ICNRequestForm icnRequestForm) {
	    ...
	    ICNResult icnResult = new ICNResult(response.readEntity(ICNEnd.class));
