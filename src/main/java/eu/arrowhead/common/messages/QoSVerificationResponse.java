...
public class QoSVerificationResponse {
  ...
  private Map<ArrowheadSystem, RejectMotivationTypes> rejectMotivation = new HashMap<>();
  ...
  public Map<ArrowheadSystem, RejectMotivationTypes> getRejectMotivation() {
    return rejectMotivation;
  }

  public void setRejectMotivation(Map<ArrowheadSystem, RejectMotivationTypes> rejectMotivation) {
    this.rejectMotivation = rejectMotivation;
  }
